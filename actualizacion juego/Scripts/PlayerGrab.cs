...
public class PlayerGrab : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // se valida si puede tener la accion de agarrar el objeto y soltarolo
            //en el cual se determinan las coliciones con el objeto 
            //y se le quita la gravedad para poderlo sostener
